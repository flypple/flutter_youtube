...
class YoutubeControls extends StatefulWidget {
  String videoName;
  YoutubeControls({Key key, this.videoName}) : super(key: key);
...
class _MaterialControlsState extends State<YoutubeControls> {
...
//        chewieController.toggleFullScreen();
        ...
        Text(widget.videoName ?? "视频", style: TextStyle(color: Colors.white,),)
